...
main( int argc, char **argv )
{
    ...
    save_params_button = GTK_WIDGET (gtk_builder_get_object (builder, "save_params_button"));
    ...
    g_signal_connect (quit_button, "clicked", G_CALLBACK (delete_event), window);
    g_signal_connect (save_params_button, "clicked", G_CALLBACK (save_params), kid1);
